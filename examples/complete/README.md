...
| <a name="output_public_ip_association_ids"></a> [public\_ip\_association\_ids](#output\_public\_ip\_association\_ids) | The public IP association ids. |
| <a name="output_subnet_association_ids"></a> [subnet\_association\_ids](#output\_subnet\_association\_ids) | The subnet NAT gateway association ids. |
